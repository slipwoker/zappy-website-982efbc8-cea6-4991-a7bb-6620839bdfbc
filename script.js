    ...
    if (contactForm) {
        ...
        const validateField = function(input) {
            ...
            if (input.type === 'tel' && value !== '') {
                const phonePattern = input.getAttribute('pattern');
                if (phonePattern) {
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '982efbc8-cea6-4991-a7bb-6620839bdfbc',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '982efbc8-cea6-4991-a7bb-6620839bdfbc';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '982efbc8-cea6-4991-a7bb-6620839bdfbc';
